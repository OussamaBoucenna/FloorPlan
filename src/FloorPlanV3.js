...
const FloorPlanV3 = () => {
  ...
  const handleMouseUp = () => {
    ...
    if (tool === "wall" && currentWall) {
      ...
      if (Math.abs(dx) > 10 && Math.abs(dy) > 10) {
        ...
        // Afficher un formulaire pour nommer la zone
  ...
  const findItemAt = (pos) => {
    ...
    // Ajoutez ceci après la détection des POIs
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-48 bg-gray-50 p-4 border-r flex flex-col">
          ...
          <div className="space-y-2 mb-4">
            ...
            <button
              className={`w-full px-3 py-2 rounded ${
                tool === "zone" ? "bg-blue-500 text-white" : "bg-gray-200"
              }`}
